...
class AboutFragment : Fragment(R.layout.fragment_about) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        versionText.text =
            "${resources.getString(R.string.version)} ${BuildConfig.VERSION_NAME} (${BuildConfig.VERSION_CODE})"
        copyrightNotice.text =
            "${resources.getString(R.string.copyright_notice)} ${resources.getString(R.string.company)}"
