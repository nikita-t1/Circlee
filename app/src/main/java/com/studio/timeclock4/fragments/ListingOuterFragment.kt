    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listingViewModel.viewModelScope.launch(Dispatchers.Main) {
            ...
            viewPager.apply {
                ...
                setCurrentItem(
                    CalendarUtils.getWeeksBetween(CalendarUtils.startDate, LocalDateTime.now())
                        .toInt(),
                    false
                )
            }
            ...
            listingViewModel.position.observe(viewLifecycleOwner, Observer {
                ...
                val startDate: String =
                    "${currentWeek.dayOfMonth} ${currentWeek.month.toString().toLowerCase()
                        .capitalize()}"
                val endDate: String =
                    " ${currentWeek.plusDays(6).dayOfMonth} ${currentWeek.plusDays(6).month.toString()
