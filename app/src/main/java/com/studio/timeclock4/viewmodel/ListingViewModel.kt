    ...
    private fun updateWorkWeek(week: LocalDateTime) {
        ...
        viewModelScope.launch() {
            ...
            val mon = async {
                _monDay.apply {
                    value =
                        repository.getWorkday(week.dayOfMonth, week.monthValue, week.year)
                            ?: emptyWorkDay
                }
            }
            ...
            val tue = async {
                _tuesDay.apply {
                    value = repository.getWorkday(
                        week.plusDays(1).dayOfMonth,
                        week.plusDays(1).monthValue,
                        week.year
                    )
                        ?: emptyWorkDay
                }
            ...
            val wed = async {
                _wednesDay.apply {
                    value = repository.getWorkday(
                        week.plusDays(2).dayOfMonth,
                        week.plusDays(2).monthValue,
                        week.year
                    )
                        ?: emptyWorkDay
                }
            ...
            val thu = async {
                _thursDay.apply {
                    value = repository.getWorkday(
                        week.plusDays(3).dayOfMonth,
                        week.plusDays(3).monthValue,
                        week.year
                    )
                        ?: emptyWorkDay
                }
            ...
            val fri = async {
                _friDay.apply {
                    value = repository.getWorkday(
                        week.plusDays(4).dayOfMonth,
                        week.plusDays(4).monthValue,
                        week.year
                    )
                        ?: emptyWorkDay
                }
            ...
            val sat = async {
                _saturDay.apply {
                    value = repository.getWorkday(
                        week.plusDays(5).dayOfMonth,
                        week.plusDays(5).monthValue,
                        week.year
                    )
                        ?: emptyWorkDay
                }
            ...
            val sun = async {
                _sunDay.apply {
                    value =
                        repository.getWorkday(
                            week.plusDays(6).dayOfMonth,
                            week.plusDays(6).monthValue,
                            week.year
                        )
                            ?: emptyWorkDay
                }
